--[[
TODO:
- When I exit a file with `ZL`, it saves the file and exits at the file's directory
...
--
--
-- trying to add my own custom scripts
--
-- Add this to your init.lua
vim.api.nvim_create_user_command('HelloWorld', function()
  require('custom.scripts.hello').hello_world()
end, {})

-- Function to go to last edit position
local function goto_last_edit()
  -- Check if the file is a valid buffer and if the last line is greater than 1
...
vim.api.nvim_create_augroup('LastEditGroup', { clear = true })

-- Set up the autocommand
vim.api.nvim_create_autocmd('BufReadPost', {
  group = 'LastEditGroup',
  callback = goto_last_edit,
})
